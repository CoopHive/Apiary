...
# SYMBOLS=("VITA" "NEURON" "ATH" "RSC" "GROW" "CRYO" "LAKE" "HAIR" "GLW_BETA" "AXGT" "NOBL")
# TOKENS=($VITA $NEURON $ATH $RSC $GROW $CRYO $LAKE $HAIR $GLW_BETA $AXGT $NOBL)
SYMBOLS=("VITA" "NEURON" "ATH" "GROW" "CRYO" "LAKE" "HAIR" "AXGT" "NOBL")
TOKENS=($VITA $NEURON $ATH $GROW $CRYO $LAKE $HAIR $AXGT $NOBL)
